    ...
    public function render(): View|Closure|string
    {
        return <<<'HTML'
            <div>
                ...
                <!-- PREFIX / PREPEND -->
                @if($prefix || $prepend)
                    <div class="rounded-l-lg flex items-center bg-base-200 @if($prefix) border border-r-0 px-4 @endif">
                        {{ $prepend ?? $prefix }}
                    </div>
                @endif
                ...
                <!-- SUFFIX/APPEND -->
                @if($suffix || $append)
                    <div class="rounded-r-lg flex items-center bg-base-200 @if($suffix) border border-l-0 px-4 @endif">
                        {{ $append ?? $suffix }}
                    </div>
                @endif
