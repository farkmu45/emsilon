<div class="btm-nav h-20 lg:hidden z-20">
  ...
  <x-bottom-nav-item link="browse" icon="heroicon-o-magnifying-glass" active-icon="heroicon-s-magnifying-glass"
    label="Browse" />
  <x-bottom-nav-item link="groups.index" icon="heroicon-o-user-group" a ctive-icon="heroicon-s-user-group" label="Groups" />
  <x-bottom-nav-item link="profile" icon="heroicon-o-user" active-icon="heroicon-s-user" label="Profile" />
</div>
